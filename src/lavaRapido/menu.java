...
public class menu {
	...
	public static void exibirMenu() {
		System.out.println("*****************************************************");
		System.out.println(cores.TEXT_CYAN_BOLD + "         LAVA RÁPIDO - Relampago Marquinhos                  "
				+ cores.TEXT_RESET);
		System.out.println("*****************************************************");
	...
	public static void cadastrarProduto() {
		...
		controller.adicionarProduto(tipo, preco);
	}
	...
	public static void comprarProduto() {
		...
		System.out.print("Escolha o produto que deseja comprar (Digite o tipo do produto): ");
		...
		if (produtoEscolhido != null) {
			System.out.println("Você comprou o produto: " + produtoEscolhido.getTipo() + " por R$ "
					+ produtoEscolhido.getPreco() + " reais");
		} else {
